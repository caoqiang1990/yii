...
(function(win,doc,undefined){
    ...
    Mysortable.prototype={
        ...
        init:function () {
            ...
            this.obj.append('<input type="text" class="answer form-control"   readonly="readonly" name="answers" style="position: absolute;z-index: 99;display:none">');
        ...
        addOptions:function (num,id,desc) {
            ...
            var html='';
            for (var i=0;i<num;i++){
                html+='<li data-id="'+id+'" class="list-group-item"><span class="sort"></span><span class="desc">'+desc+'</span>' +
                    '<span  class="edit">' +
